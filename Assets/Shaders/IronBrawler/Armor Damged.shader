...
Shader "Armor Damged"
{
	Properties
	{
		...
		[TCP2Vector4FloatsDrawer(Speed,Amplitude,Frequency,Offset)] _Albedo_SinAnimParams ("Albedo Texture UV Sine Distortion Parameters", Float) = (1, 0.05, 1, 0)
		[TCP2Separator]
	...
	SubShader
	{
		...
		// Shader Properties
		sampler2D _BaseMap;sampler2D _Albedo;
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float2 uvSinAnim__Albedo = (input.pack0.zw * _Albedo_SinAnimParams.z) + (_Time.yy * _Albedo_SinAnimParams.x);
								// Shader Properties Sampling
				float4 __albedo = ( tex2D(_BaseMap, input.pack0.xy.xy + frac(_Time.yy * _BaseMap_SC.xy)).rgba * tex2D(_Albedo, input.pack0.xy.xy * _Albedo_ST.xy + _Albedo_ST.zw + (((sin(0.9 * uvSinAnim__Albedo + _Albedo_SinAnimParams.w) + sin(1.33 * uvSinAnim__Albedo + 3.14 * _Albedo_SinAnimParams.w) + sin(2.4 * uvSinAnim__Albedo + 5.3 * _Albedo_SinAnimParams.w)) / 3) * _Albedo_SinAnimParams.y)).rgba );
...
/* TCP_DATA u config(unity:"2020.1.3f1";ver:"2.6.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","OUTLINE","OUTLINE_BEHIND_STENCIL","OUTLINE_CONSTANT_SIZE","OUTLINE_PIXEL_PERFECT","OUTLINE_CLIP_SPACE","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:True;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_BaseMap";md:"";custom:False;refs:"";guid:"2ad3f4db-76f1-4897-9909-e60cef1a1212";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:True;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_Albedo";md:"";custom:False;refs:"";guid:"32dd9c10-995f-43ca-a29d-e54cbe34cdd1";op:Multiply;lbl:"Albedo Texture";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 8f92f370fa1b54ca98cd9f8587869861 */
